"""
Weather Agent for EcoSync
This module implements a weather forecasting agent using the Model Context Protocol.
"""
import os
import asyncio
...
async def run_weather_agent(query: str):
    """
    Runs the weather agent with the given query.
    ...
    async with MCPServerStdio(
        ...
        params={
            "command": "mcp",
            "args": ["run", "app/agents/mcp_server.py"]
        },
